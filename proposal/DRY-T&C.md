...
This is a [living document](https://en.wikipedia.org/wiki/Living_document), so please don't assume a finished state. Suggestions are welcome! (**warning:** I [haven't chosen an open license](https://choosealicense.com/no-permission), yet).
